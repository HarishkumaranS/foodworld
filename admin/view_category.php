...
<!-- heading -->
<h4 align="center"><b>View Categories</b></h4>
<?php
// database connection
...
while($row=mysqli_fetch_array($result_cat))
{
            ...
            echo "<tr><td scope='row'>$cat_id</td><td>$cat_name</td></td><td><a href='admin.php?CEid=$cat_id'><i class='fa-solid fa-pen-to-square edit_color'></i></a></td><td><a onclick='del_cat()'><i class='fa-solid fa-trash del_color'></i></a></td></tr>";
}
echo "</tbody></table>";
}
else{
...
<script>
    ...
    {
    // js href link
        window.location.href='admin.php?CDid=<?php echo $cat_id ?>';
    }
}
</script>
