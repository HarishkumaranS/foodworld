    ...
    <table align='center' class='table table-striped table-light'>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <div class="form-outline w-10 m-1">
                        <input type="text" name="value" class="form-control w-100" placeholder="Enter the value" value="<?php if(isset($_POST['value'])){echo $_POST['value'];}?>" required>
                    </div>
                </td>
                <td>
                    <div class="form-outline w-10 m-1">
     ...
     if($_POST['select']=='o_id')
     {
       ...
       else
       {
        echo "<script>alert('Invalid input...!!');
            window.location.href='admin.php?delivered_order';</script>";
       }
     }
...
$select_qry = "SELECT * FROM user_order WHERE status=1".$add_qry;
