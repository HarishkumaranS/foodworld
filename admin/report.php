    ...
    <table align='center' class='table table-striped table-light'>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <div class="form-outline w-10 m-1">
                        <input type="text" name="value" class="form-control w-100" placeholder="Enter the value" value="">
                    </div>
                </td>
                <td>
                    <div class="form-outline w-10 m-1">
                        <input type="text" name="f_date" class="form-control w-100" placeholder="Enter the From Date" value="">
                    </div>
                </td>
                <td>
                    <div class="form-outline w-10 m-1">
                        <input type="text" name="t_date" class="form-control w-100" placeholder="Enter the To Date" value="" >
                    </div>
                </td>
                <td>
                    <div class="form-outline w-10 m-1">
                ...
                <td>
                    ...
                    <form action="pdf.php" method="post">
                     <!-- refers the line 118, 119, 125, 132 139 and 140 in same page -->
                        <button name="submit" class="btn btn-info"><i class="fa-regular fa-file-pdf pdf_icon"></i></button>
                    </div>
    ...
    // print_r($_POST);
     if($_POST['select']=='u_name' && isset($_POST['value']))
     {
        ...
        elseif($num>1)
        {
            ...
            window.location.href='admin.php?report';</script>";
        }
        else {
...
if ($num > 0) {
    echo "<table align='center' class='table table-striped table-light'><thead class='thead-dark'><tr><th scope='col'>O.No</th><th scope='col'>User Name</th><th scope='col'>Product Name</th><th scope='col'>QTY</th><th scope='col'>Price</th><th scope='col'>O Date</th><th scope='col'>D Date</th><th scope='col'>Status</th><th scope='col'>Payment Type</th></tr></thead><tbody>";
    while ($row = mysqli_fetch_array($result_select)) {
        $pay_id = $row['payment_id'];
        $user_id = $row['user_id'];
        $product_id = $row['product_id'];
        $select_qry_join = "SELECT pay.payment_type,u.user_name,pro.product_name from payment pay,product pro,user u where pay.payment_id=$pay_id and u.user_id=$user_id and pro.product_id=$product_id";
        ...
        echo "<tr><td scope='row'>$order_id</td><td>$user_name</td><td>$product_name</td><td>$qty</td><td>$price</td><td>$o_date</td><td>$d_date</td><td>$status</td><td>$payment_type</td></tr>";
        // echo "<pre>";
        // print_r($row_join);
        // echo "</pre>";
    }
