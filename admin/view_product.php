...
<!-- heading -->
<h4 align="center"><b>View Product</b></h4>
<?php
...
<thead class='thead-dark'>
    ...
    <tbody>
    <tr>
        <td><div class="form-outline w-10 m-1">
    <input type="text" name="product_id" class="form-control w-10" placeholder="Enter Product Id">
  </div></td>
        <td><div class="form-outline w-10 m-1">
    <input type="text" name="product_name" class="form-control w-100" placeholder="Enter Product Name">
  </div></td>
        <td><div class="form-outline m-1">
...
if(isset($_POST['submit']))
{
    ...
    {
        $sort_list.="WHERE product_id='$sort_p_id'";
    }
    elseif(isset($sort_p_name) && !empty($sort_p_name))
    {
        $sort_list.="WHERE product_name LIKE'%$sort_p_name%'";
    }
    elseif(isset($sort_p_cat) && !empty($sort_p_cat))
    {
        $sort_list.="WHERE product_cat='$sort_p_cat'";
    }
}
...
while($row=mysqli_fetch_array($result_product))
{
            ...
            echo "<tr><td scope='row'>$product_id</td><td>$product_name</td><td >$product_scale</td><td  >$product_keyword</td><td class='truncate-text'>$product_des</td><td>$product_cat</td>
            ...
            <td> $product_stock</td>
            <td><a class='nav-link' href='admin.php?PEid=$product_id'><i class='fa-solid fa-pen-to-square edit_color'></i></a></td><td><a class='nav-link' onclick='del_product()'><i class='fa-solid fa-trash del_color'></i></a></td></tr>";
}
echo "</tbody></table>";
}
else
...
<script>
    ...
    {
    //  js href link
        window.location.href='admin.php?PDid=<?php echo $product_id ?>';
    }
}
</script>
