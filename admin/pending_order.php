...
while($row=mysqli_fetch_array($result_select))
{
    ...
    echo "<tr><th scope='row'>$order_id</th><td>$user_name</td><td>$product_name</td><td>$qty</td><td>$price</td><td>$o_date</td><td>$d_date</td><td>$status</td><td>$payment_type</td><td><input type='checkbox' name='status$order_id' class='form-check-input border border-dark' id='flexCheckChecked' value='$order_id'></td></tr>";
}
...
if(isset($_POST['submit']))
    {
        ...
        if($reslut_qry)
        {
            echo "<script>window.location.href='admin.php?pending_order';</script>";
        }
    }
    else
{
