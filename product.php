...
function cat()
{
  global $con;
  $cat = $_GET['cat'];
  $select_qry = "SELECT * FROM product WHERE product_cat='$cat' ORDER BY rand()";
...
function user_serch()
{
  ...
  $select_qry = "SELECT * FROM product WHERE product_keyword LIKE'%$user_serch%' ORDER BY rand()";
  $result_select = mysqli_query($con, $select_qry);
$num_item = mysqli_num_rows($result_select);
if($num_item <= 0)
{
...
function all_product() {
  global $con;
  $select_qry = "SELECT * FROM product ORDER BY rand()";
  $result_select = mysqli_query($con, $select_qry);
$num_item = mysqli_num_rows($result_select);
while ($row = mysqli_fetch_array($result_select)) {
  $product_name = $row['product_name'];
